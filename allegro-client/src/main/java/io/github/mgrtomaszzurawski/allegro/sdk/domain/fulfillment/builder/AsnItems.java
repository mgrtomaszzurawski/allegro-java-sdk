 ...
 * spec's {@code quantity} bounds identically. Package-private — not part of the
 * public surface.
 */
final class AsnItems {
    ...
    /** Validate a product line and return it, or throw if the id is blank or the quantity out of range. */
